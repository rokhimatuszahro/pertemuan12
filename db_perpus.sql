...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 22 Agu 2021 pada 17.35
...
INSERT INTO `tb_anggota` (`id_anggota`, `nama`, `jenkel`, `alamat`, `status`) VALUES
('B0001', 'Rokhimatus Zahro', 'Wanita', 'Jatilawang, Tegalwangi', 'Tidak Meminjam'),
('B0002', 'Willy', 'Pria', 'Semboro', 'Meminjam');
...
('A0006', 'Gersang', 'Retno Ningsih', 'Mentari ', 1997);
...
(2, 'Nike', 'kinerjarb.situbondo@', '12345678', 'Admin'),
(4, 'Rokhimatus Zahro', 'adminpemda@gmail.com', '1234', 'Admin'),
(7, 'asd', 'rmatuszahro@gmail.co', '12345678', 'Anggota');
